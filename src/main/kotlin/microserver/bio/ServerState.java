...
public class ServerState {
     ...
     * 连接集合
     */
    private ConcurrentHashMap<String, MicroConnection> connectionMap = new ConcurrentHashMap<String, MicroConnection>();
    ...
    public String getLocalAddress() {
        return mServer.getMConfig().getLocalAddress();
    }

    public int getPort() {
        return mServer.getMConfig().getPort();
    }
